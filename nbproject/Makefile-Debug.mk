...
${OBJECTDIR}/Nhan2MatranMPI.o: Nhan2MatranMPI.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Nhan2MatranMPI.o Nhan2MatranMPI.c

${OBJECTDIR}/PhuongTrinhNhiet1D_C.o: PhuongTrinhNhiet1D_C.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PhuongTrinhNhiet1D_C.o PhuongTrinhNhiet1D_C.c
...
${OBJECTDIR}/bai_tap_mot.o: bai_tap_mot.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bai_tap_mot.o bai_tap_mot.c

${OBJECTDIR}/example_mpi.o: example_mpi.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/example_mpi.o example_mpi.c

${OBJECTDIR}/example_temperature.o: example_temperature.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/example_temperature.o example_temperature.cpp

${OBJECTDIR}/my_matrix_multiplication.o: my_matrix_multiplication.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/my_matrix_multiplication.o my_matrix_multiplication.c

${OBJECTDIR}/nhan2matran_MPI_Bcast_demo.o: nhan2matran_MPI_Bcast_demo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nhan2matran_MPI_Bcast_demo.o nhan2matran_MPI_Bcast_demo.c

${OBJECTDIR}/nhan2matran_MPI_Gather.o: nhan2matran_MPI_Gather.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nhan2matran_MPI_Gather.o nhan2matran_MPI_Gather.c

${OBJECTDIR}/nhan2matran_MPI_Scatter_demo.o: nhan2matran_MPI_Scatter_demo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nhan2matran_MPI_Scatter_demo.o nhan2matran_MPI_Scatter_demo.c

${OBJECTDIR}/thi.o: thi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thi.o thi.cpp

${OBJECTDIR}/thi_mp.o: thi_mp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thi_mp.o thi_mp.cpp
